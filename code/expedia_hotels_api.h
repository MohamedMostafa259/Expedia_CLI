 ...
 *      Author: Dr. Mostafa Saad Ibrahim => His GitHub: https://github.com/mostafa-saad
 *
 * 	He provided us with this dummy APIs in his great Udemy Course: ↓ ↓ ↓
 * 		https://www.udemy.com/share/103GjP3@CpoI0V4YIqdHCuKOMQ2Q7ysCnzVANr9HKR9C0i964WO325Ys0ww_XVQvK4H0L8zmHg==/
 */
...
public:
	...
	virtual vector<HotelRoom> SearchHotelRooms() override {
...
public:
	...
	virtual vector<HotelRoom> SearchHotelRooms() override {
		...
		vector<MarriottFoundRoom> api_rooms = MarriottHotelAPI::FindRooms(request.GetFromDate(), request.GetToDate(), request.GetCountry(),
														request.GetCity(), request.GetRooms(), request.GetAdults(), request.GetChildren());
		vector<HotelRoom> rooms;
