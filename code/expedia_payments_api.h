...
// High-level modules (expedia.com) should not depend on low-level modules (AirCanadaAirlines/PaypalPayment APIs).
// Both should depend on abstractions (e.g. IFlightsFinder and IPayment).
